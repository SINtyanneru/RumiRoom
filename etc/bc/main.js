...
function render(spectrum) {
	...
	// 色
	canvasContext.fillStyle = 'rgb(0, 192, 255)';
...
//再生/一時停止の制御
function play_pause_btn_Click() {
	// pausedがtrue=>停止, false=>再生中
	if (!audio.paused) {
		audio.pause();
		var textModMsg = document.getElementById('vfd');
		textModMsg.textContent = "Pause";
	} else {
		audio.play();
		var textModMsg = document.getElementById('vfd');
		textModMsg.textContent = "Play";
	}
}
//停止
